...
public final class TipoCambioMensual implements Iterable<Map.Entry<LocalDate, BigDecimal>> {
    ...
    public TipoCambioMensual(TreeMap<LocalDate, BigDecimal> exchangeRates) {
    ...
    public BigDecimal getTipoDeCambio(LocalDate date) {
    ...
    public String toString() {
        return "TipoCambioMensual{" + exchangeRates + '}';
    }
}
