 ...
 * generated in the ni.jug.exchangerate.soap package.
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ni.jug.exchangerate.soap
     */
